/**
 * AdFlakeAdapterGoogleAdMob.h (AdFlakeSDK-Sample)
 *
 ...
 *
 * @file AdFlakeAdapterGoogleAdMob.h
 * @copyright 2013 MADE GmbH. All rights reserved.
 * @section License
...
@interface AdFlakeAdapterAdColonyVideo : AdFlakeAdNetworkAdapter<AdColonyDelegate, AdColonyAdDelegate> {
}
