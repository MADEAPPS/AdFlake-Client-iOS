/**
 * AdFlakeCustomAdView.m (AdFlakeSDK-Sample)
 *
...
@implementation AdFlakeCustomAdView
...
- (id)initWithDelegate:(id<AdFlakeCustomAdViewDelegate>)d
                  text:(NSString *)txt
           redirectURL:(NSURL *)rURL
       clickMetricsURL:(NSURL *)cURL
                adType:(AFCustomAdType)aType
            launchType:(AFCustomAdLaunchType)launch
              animType:(AFCustomAdWebViewAnimType)anim
...
- (void)drawRect:(CGRect)rect {
	...
	else if (adType == AFCustomAdTypeBanner) {
